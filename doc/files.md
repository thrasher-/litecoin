...
`./`               | `litecoin.conf`        | Contains [configuration settings](bitcoin-conf.md) for `litecoind` or `litecoin-qt`; can be specified by `-conf` option
...
`addr.dat`     | Peer IP address BDB database; replaced by `peers.dat` in [0.7.0](https://github.com/litecoin-project/litecoin/blob/master/doc/release-notes/release-notes-0.7.0.md) | [PR #1198](https://github.com/bitcoin/bitcoin/pull/1198), [`928d3a01`](https://github.com/litecoin-project/litecoin/commit/928d3a011cc66c7f907c4d053f674ea77dc611cc)
